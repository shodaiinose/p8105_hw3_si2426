...
```
    ...
    ## 1 US1NYMD0002 2008-09-03     0     0    NA <NA>  <NA> 
    ## 2 USC00306184 2005-01-30     0     0    NA -6    -267 
    ## 3 USC00309670 1981-09-15     0     0     0 300   183  
    ## 4 USC00305796 1988-12-26     0     0     0 39    -6   
    ## 5 USC00300085 2005-10-24   249     0     0 33    11
...
The plots above depict the mean maximum temperature recorded by each
station by year in January and July, respectively. Overall, it appears
that the mean maximum temperature trends higher in July than in January.
Overall, the trend appears steady in July, ranging primarily between 20
and 30 degrees Celsius with exceptions. However, there appears to be a
possible slight upwards trend when looking at the January data,
especially between 1980 and 1990. The January temperatures appear to
range primarily between -10 and 10 degrees Celsius. There are several
...
![](p8105_hw3_si2426_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->

In the plot comparing maximum temperature to minimum temperature, there
